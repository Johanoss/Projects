        ...
        return AlertDialog(
          ...
          actions: [
            TextButton(
              ...
              child: const Text(
                "Cancel",
                style: TextStyle(color: sanJuanWash),
              ),
            ),
            ElevatedButton(
              style: ElevatedButton.styleFrom(
...
// --- 6. ADAPTIVE BENTO HOME (WITH PROFILE PICTURE ON RIGHT, DELETE BUTTON, AND CLICKABLE FRIENDS) ---
  ...
  Future<void> _deleteProfile() async {
    try {
      showDialog(
        ...
        builder: (BuildContext context) {
          return const Center(
            child: CircularProgressIndicator(color: sanJuanLight),
          );
        },
      );
